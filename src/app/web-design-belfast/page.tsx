            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-20">
              ...
              <div className="lg:col-span-2">
                <h2
                  ...
                  style={{ letterSpacing: '-0.04em' }}
                >
                  Everything you need to stand out online — from one Belfast studio.
                </h2>
                {/* List-style like YD services section */}
                <div className="border-t border-[#e5e5e5]">
                  {[
                    { title: 'Custom Web Design', desc: 'Bespoke designs that reflect your brand — not cookie-cutter templates.' },

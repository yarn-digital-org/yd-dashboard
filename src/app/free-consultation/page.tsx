...
export default function FreeConsultationPage() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      const res = await fetch('/api/public/leads', {
        ...
        body: JSON.stringify({ ...formData, source: 'landing-page-brand', ...utm }),
      });
  ...
  return (
    <>
      <ForceLightTheme />
      <PageViewTracker page="free-consultation" />
        ...
        <section className="py-24 sm:py-36 bg-[#ffffff]">
          <div className="max-w-[1520px] mx-auto px-5 sm:px-10">
            <p
              ...
              style={{ letterSpacing: '-0.03em' }}
            >
              We&apos;re a full-service digital agency that puts strategy first. We help businesses across Belfast and Northern Ireland grow with design, development, and marketing that actually delivers results.
            </p>
          </div>
        </section>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 lg:gap-20">
              ...
              <div>
                ...
                <div className="flex flex-col gap-2 text-xs text-[#444] font-medium">
                  ...
                  <span>✓ 30-minute call included</span>
                </div>
              </div>
                ...
                {status === 'success' ? (
                  <div className="py-16 text-center lg:text-left">
                    ...
                    <p className="text-sm text-[#666] font-medium" style={{ letterSpacing: '-0.02em' }}>
                      We&apos;ll be in touch within 1 business day to arrange your consultation.
                    </p>
                  </div>
                ) : (
              ...
              <div className="lg:col-span-2">
                ...
                <div className="border-t border-[#e5e5e5]">
                  {[
                    ...
                    { title: 'Full-Service Team', desc: 'Branding, web design, SEO, content, and paid ads — all under one roof.' },
                    { title: 'Local Expertise', desc: 'Belfast-based, NI-focused. We understand your market and your customers.' },
                    { title: 'Transparent Pricing', desc: 'Fixed quotes, clear timelines. No hidden fees, no scope creep surprises.' },
                    { title: 'Proven Track Record', desc: 'Real results for real businesses — not vanity metrics.' },
                    { title: 'Long-Term Partnership', desc: 'We\'re not a one-project shop. We grow with you.' },
                  ].map((item, i) => (
        ...
        <section className="relative py-28 sm:py-36 overflow-hidden">
          ...
          <div className="relative z-10 max-w-3xl mx-auto px-5 sm:px-10 text-center">
            ...
            <p className="text-base text-white/50 mb-10" style={{ letterSpacing: '-0.02em', fontWeight: 500 }}>
              No obligation. No sales pitch. Just a conversation about your goals.
            </p>

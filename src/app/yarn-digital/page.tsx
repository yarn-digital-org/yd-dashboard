  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      const res = await fetch('/api/public/leads', {
        ...
        body: JSON.stringify({ ...formData, source: 'landing-page-brand-yarn-digital', ...utm }),
      });
        ...
        <section className="relative min-h-screen overflow-hidden">
          ...
          <div className="relative z-10 max-w-[1520px] mx-auto px-5 sm:px-10 flex flex-col justify-end min-h-screen pb-16 sm:pb-20 pt-32">
            ...
            <div className="max-w-2xl">
              ...
              >
                We&apos;re not a faceless agency. We&apos;re a small team in Belfast<br className="hidden sm:block" />
                who genuinely care about helping SMEs grow.<br className="hidden sm:block" />
                Brand, website, marketing — all under one roof.
              </p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-20">
              ...
              <div className="lg:col-span-2">
                <h2
                  ...
                  style={{ letterSpacing: '-0.04em' }}
                >
                  Full-service digital — everything you need under one roof.
                </h2>
                {/* List-style like YD services section */}
                <div className="border-t border-[#e5e5e5]">
                  {[
                    { title: 'Brand Strategy', desc: 'Research-driven positioning that makes your business impossible to ignore.' },
                    { title: 'Web Design & Development', desc: 'Fast, beautiful, responsive websites built on Shopify, WordPress, or custom.' },
                    { title: 'SEO & Content', desc: 'Get found by the right people with sustainable organic growth strategies.' },
                    { title: 'Digital Marketing', desc: 'Paid ads, social media, and campaigns that actually move the needle.' },
                    { title: 'UX / UI Design', desc: 'Interfaces that feel intuitive and look exceptional across every device.' },
                    { title: 'Ongoing Growth', desc: 'We don\'t disappear after launch. Analytics, optimisation, and continuous improvement.' },
                  ].map((item, i) => (
          ...
          <div className="relative z-10 max-w-3xl mx-auto px-5 sm:px-10 text-center">
            ...
            <div className="flex flex-wrap gap-3 justify-center">
              <button
                ...
                style={{ letterSpacing: '-0.02em' }}
              >
                Start My Project <ArrowRight size={15} />
              </button>
              <a

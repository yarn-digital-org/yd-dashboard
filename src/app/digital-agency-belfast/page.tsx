...
export default function DigitalAgencyBelfastPage() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      const res = await fetch('/api/public/leads', {
        ...
        body: JSON.stringify({ ...formData, source: 'landing-page-digital-agency-belfast', ...utm }),
      });
  ...
  return (
    <>
      <ForceLightTheme />
      <PageViewTracker page="digital-agency-belfast" />
      ...
      <main className="min-h-screen bg-[#0a0a0a] font-sans antialiased landing-page" style={{ letterSpacing: '-0.02em' }}>
          ...
          <div className="relative z-10 max-w-[1520px] mx-auto px-5 sm:px-10 flex flex-col justify-end min-h-screen pb-16 sm:pb-20 pt-32">
            <div className="max-w-3xl">
              ...
              <h1 className="text-[2.75rem] sm:text-6xl lg:text-[4.5rem] font-medium text-white leading-[1.02] mb-6" style={{ letterSpacing: '-0.03em' }}>
                Belfast&apos;s Digital Agency<br />for Ambitious SMEs.
              </h1>
              ...
              <p className="text-base sm:text-lg text-white/60 leading-relaxed mb-8 max-w-xl" style={{ letterSpacing: '-0.01em', fontWeight: 400 }}>
                Brand strategy, web design, SEO, and digital marketing — all under one roof. No juggling agencies. Just results.
              </p>
        ...
        <section className="py-20 sm:py-28 bg-[#0a0a0a] border-b border-[#1a1a1a]">
          <div className="max-w-[1520px] mx-auto px-5 sm:px-10">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-20 mb-14">
              <div>
                <span className="text-[11px] font-semibold text-[#555] uppercase" style={{ letterSpacing: '0.08em' }}>What We Do</span>
              </div>
              <div className="lg:col-span-2">
                <h2 className="text-3xl sm:text-4xl font-medium text-white leading-[1.1]" style={{ letterSpacing: '-0.04em' }}>
                  Everything you need to grow online — from one team.
                </h2>
              </div>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-0 border-t border-[#1a1a1a]">
              {[
                { title: 'Brand & Identity', desc: 'Strategy, logo, and visual identity that earns trust before a word is read.', link: '/new-brand' },
                { title: 'Web Design', desc: 'Fast, mobile-first websites built to convert visitors into enquiries.', link: '/web-design-belfast' },
                { title: 'SEO Belfast', desc: 'Get found on Google by the right customers, in the right location.', link: '/seo-belfast' },
                { title: 'Digital Marketing', desc: 'Paid search, social, and content — all joined up, all measurable.', link: '/digital-marketing-belfast' },
              ].map((s, i) => (
                <a key={i} href={s.link} className={`group block py-8 md:px-8 ${i === 0 ? 'md:pl-0' : ''} ${i < 3 ? 'border-b md:border-b-0 md:border-r border-[#1a1a1a]' : ''} hover:bg-[#111] transition-colors`}>
        ...
        <section className="py-20 sm:py-28 bg-[#ffffff]">
          <div className="max-w-[1520px] mx-auto px-5 sm:px-10">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-20 mb-14">
              <div>
                <span className="text-[11px] font-semibold text-[#999] uppercase" style={{ letterSpacing: '0.08em' }}>Why Yarn Digital</span>
              </div>
              <div className="lg:col-span-2">
                <h2 className="text-3xl sm:text-4xl font-medium text-[#0a0a0a] leading-[1.1]" style={{ letterSpacing: '-0.04em' }}>
                  One team. Full service. Real results.
                </h2>
              </div>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-0 border-t border-[#e5e5e5]">
              {[
                { num: '01', title: 'Belfast-based', desc: 'We know the local market. We work with Belfast SMEs every day — we understand what your customers are searching for and how to reach them.' },
                { num: '02', title: '48-hour turnaround', desc: 'Fast without cutting corners. Most audits, reports, and proposals are back with you within 48 hours. No waiting weeks for a response.' },
                { num: '03', title: 'Growth-focused', desc: 'We don\'t build websites for the sake of it. Everything is built around one goal: more enquiries, more bookings, more customers for your business.' },
              ].map((p, i) => (
        ...
        <section id="audit-form" className="bg-[#0a0a0a] py-24 sm:py-32">
          <div className="max-w-[1520px] mx-auto px-5 sm:px-10">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 lg:gap-20">
              <div>
                <span className="text-[11px] font-semibold text-[#555] uppercase block mb-6" style={{ letterSpacing: '0.08em' }}>Free Audit</span>
                <h2 className="text-3xl sm:text-4xl font-medium text-white leading-[1.1] mb-6" style={{ letterSpacing: '-0.04em' }}>Book your free audit</h2>
                <p className="text-sm text-[#555] leading-relaxed mb-8" style={{ letterSpacing: '-0.01em', fontWeight: 500 }}>
                  Tell us about your business and we&apos;ll show you exactly how to get more leads online.
                </p>
        ...
        <section className="relative py-28 sm:py-36 overflow-hidden">
          ...
          <div className="relative z-10 max-w-3xl mx-auto px-5 sm:px-10 text-center">
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-medium text-white leading-[1.1] mb-5" style={{ letterSpacing: '-0.04em' }}>
              Ready to work with Belfast&apos;s<br />full-service digital agency?
            </h2>
            <p className="text-base text-white/50 mb-10" style={{ letterSpacing: '-0.02em', fontWeight: 500 }}>
              Free 30-minute consultation. No obligation, no sales pitch.
            </p>

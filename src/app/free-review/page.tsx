...
export default function FreeReviewPage() {
  const [formData, setFormData] = useState({
    name: '', email: '', website: '', keyword: '', phone: '',
  });
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      const res = await fetch('/api/public/leads', {
        ...
        body: JSON.stringify({ ...formData, source: 'landing-page-problem-solution', ...utm }),
      });
        ...
        <section className="py-24 sm:py-36 bg-[#ffffff]">
          <div className="max-w-[1520px] mx-auto px-5 sm:px-10">
            <p
              ...
              style={{ letterSpacing: '-0.03em' }}
            >
              We&apos;ll show you exactly where you rank, what your competitors are doing better, and give you a clear action plan to fix it — no jargon, no sales pitch.
            </p>
          </div>
        </section>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 lg:gap-20">
              ...
              <div>
                ...
                <div className="flex flex-col gap-2 text-xs text-[#444] font-medium">
                  ...
                  <span>✓ Clear action plan, no jargon</span>
                  <span>✓ Local specialists — Belfast &amp; NI</span>
                </div>
              </div>
                ...
                {status === 'success' ? (
                  <div className="py-16 text-center lg:text-left">
                    ...
                    <p className="text-sm text-[#666] font-medium" style={{ letterSpacing: '-0.02em' }}>
                      We&apos;ll be in touch within 1 business day with your free review.
                    </p>
                  </div>
                ) : (
                  <form onSubmit={handleSubmit} className="space-y-8 pt-2">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-10 gap-y-6">
                      <div>
                        <label className={labelClass} style={{ letterSpacing: '0.04em' }}>Primary keyword you want to rank for</label>
                        <input type="text" placeholder="e.g. plumber belfast" className={inputClass}
              ...
              <div className="lg:col-span-2">
                ...
                <div className="border-t border-[#e5e5e5]">
                  {[
                    ...
                    { title: 'SEO Health Check', desc: 'Technical issues, missing meta data, and crawl errors that are costing you traffic.' },
                    { title: 'Page Speed Analysis', desc: 'How fast your site loads and what\'s slowing it down.' },
                    { title: 'Mobile Experience', desc: 'How your site performs on the devices your customers actually use.' },
                    { title: 'Competitor Comparison', desc: 'Side-by-side analysis of how you stack up against local competition.' },
                    { title: 'Action Plan', desc: 'Prioritised, jargon-free recommendations you can act on immediately.' },
                  ].map((item, i) => (

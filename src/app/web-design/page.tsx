...
import { Star, CheckCircle, ArrowRight, Loader2, Monitor, Smartphone, Zap } from 'lucide-react';
...
function LeadForm() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      const res = await fetch('/api/public/leads', {
        ...
        body: JSON.stringify({
          ...formData,
          source: 'landing-page-web-design',
          ...utm,
        }),
      });
    ...
    return (
      <div className="text-center py-12 px-6">
        ...
        <p className="text-gray-600 text-lg">
          We&apos;ll be in touch within 1 business day with your free website audit.
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div>
        <label htmlFor="website" className={labelClasses}>Current Website URL</label>
      ...
      <div>
        <label htmlFor="message" className={labelClasses}>What&apos;s not working with your website? (optional)</label>
        <textarea id="message" rows={3} placeholder="Tell us what frustrates you about your current site..." className={inputClasses + ' resize-none'}
      ...
      <p className="text-center text-sm text-gray-500">
        No sales pitch. No strings. Just an honest look at what&apos;s holding your site back.
      </p>
    </form>
  );
}
      ...
      <main className="min-h-screen">
        ...
        <section className="bg-[#0a0a0a] text-white">
          <div className="max-w-4xl mx-auto px-6 py-20 sm:py-28 text-center">
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold leading-tight mb-6">
              ...
              Working for You —
              <br />
              <span className="text-[#ff3300]">or Against You.</span>
            </h1>
            <p className="text-lg sm:text-xl text-gray-300 max-w-2xl mx-auto mb-8 leading-relaxed">
              A great website doesn&apos;t just look good — it turns visitors into customers.
              If yours isn&apos;t converting, we&apos;ll tell you exactly why. For free.
            </p>
        ...
        <section className="bg-white py-16 sm:py-20">
          <div className="max-w-3xl mx-auto px-6 text-center">
            <h2 className="text-3xl sm:text-4xl font-extrabold text-[#0a0a0a] mb-6">
              A Website That Doesn&apos;t Convert Is Costing You Money.
            </h2>
            <p className="text-lg text-gray-600 leading-relaxed mb-4">
              Your site loads slowly. It doesn&apos;t look right on a phone. Visitors land on your
              homepage and leave without getting in touch. You know it needs work, but you&apos;ve
              been burned by a web agency before.
            </p>
            <p className="text-lg text-gray-600 leading-relaxed">
              We build websites that actually do their job — bring in enquiries, look professional,
              and work on every device.
            </p>
          </div>
        </section>
        ...
        <section className="bg-gray-50 py-16 sm:py-20">
          <div className="max-w-5xl mx-auto px-6">
            <h2 className="text-3xl sm:text-4xl font-extrabold text-[#0a0a0a] mb-10 text-center">
              Websites Built to Convert — Not Just to Look Pretty.
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <ServiceCard
                icon={<Monitor className="w-8 h-8" />}
                title="Custom Design"
                description="No templates. Every site is designed around your business, your customers, and your goals. Shopify, WordPress, or fully custom."
              />
              <ServiceCard
                icon={<Smartphone className="w-8 h-8" />}
                title="Mobile-First"
                description="Over 70% of your visitors are on their phone. Every site we build looks and works perfectly on mobile — not as an afterthought."
              />
              <ServiceCard
                icon={<Zap className="w-8 h-8" />}
                title="Built for Speed"
                description="Fast loading, clean code, SEO-ready from day one. A slow website loses customers before they even see what you offer."
              />
            </div>
          </div>
        </section>
        ...
        <section className="bg-white py-16 sm:py-20">
          <div className="max-w-5xl mx-auto px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <CaseStudy
                name="Krumb Bakery"
                situation="Growing bakery with no online presence worth visiting."
                work="Brand-new website built around the product — warm, inviting, easy to navigate."
        ...
        <section className="bg-gray-50 py-16 sm:py-20">
          <div className="max-w-3xl mx-auto px-6 text-center">
            ...
            <p className="text-lg text-gray-600 leading-relaxed mb-4">
              Yarn Digital is a full-service studio led by Jonny Davison. We build websites for
              ambitious SMEs across Belfast and Northern Ireland — properly designed, properly built,
              and yours to manage.
            </p>
            <p className="text-lg text-gray-600 leading-relaxed">
        ...
        <section className="bg-white py-16 sm:py-20" ref={formRef}>
          <div className="max-w-2xl mx-auto px-6">
            <div className="text-center mb-8">
              ...
              <p className="text-lg text-gray-600 leading-relaxed">
                Get a free website audit. We&apos;ll look at your site&apos;s speed, mobile experience,
                SEO, and conversion setup — and tell you what we&apos;d fix first. No obligation.
              </p>
            </div>
